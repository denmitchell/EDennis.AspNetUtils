...
builder.Services.AddHttpClient("EDennis.AspNetUtils.Tests.BlazorSample.WA.ServerAPI", client => client.BaseAddress = new Uri(builder.HostEnvironment.BaseAddress))
